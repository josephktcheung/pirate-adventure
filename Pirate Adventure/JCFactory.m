...
@implementation JCFactory

-(NSArray *)tiles
{
    
    JCTile *tile1 = [[JCTile alloc] init];
    ...
    JCWeapon *bluntedSword = [[JCWeapon alloc] init];
    ...
    JCTile *tile4 = [[JCTile alloc] init];
    ...
    JCTile *tile12 = [[JCTile alloc] init];
...
{
    JCCharacter *character = [[JCCharacter alloc] init];
    character.health = 100;
    
    JCArmor *armor = [[JCArmor alloc] init];
    armor.name = @"Cloak";
    armor.health = 5;
    character.armor = armor;
    
    JCWeapon *weapon = [[JCWeapon alloc] init];
    weapon.name = @"Fists";
    weapon.damage = 10;
